...
object ImProcMain extends App {
    val MAX_WIDTH = 1280
    val MAX_HEIGHT = 720
    iotesters.Driver.execute (args, () => new ChiselImProc (24, 7, MAX_WIDTH, MAX_HEIGHT)) {
...
object ImProcRepl extends App {
    val MAX_WIDTH = 1280
    val MAX_HEIGHT = 780
    iotesters.Driver.executeFirrtlRepl (args, () => new ChiselImProc(24, 7, MAX_WIDTH, MAX_HEIGHT))
}
